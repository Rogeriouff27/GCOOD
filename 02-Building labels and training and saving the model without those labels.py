...
if __name__=='__main__':
    ...
    model = all_classifiers(num_class = 10, type_model = 'resnet', network_pretrained = False, path_weight = config_data_classifiers['path_folder_save_weight'], num_epoch = config_data_classifiers['epochs'])
    ...
    _, _, _, dic_label_color, _, _ = get_informatios_graph_coloring()
